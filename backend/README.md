...
## Project Structure
    ...
    ├── blackbaud_demo_with_40828  # Django project configurations
...
1. Clone this repo and `cd blackbaud_demo_with_40828`
...
2. Clone this repo and `cd blackbaud_demo_with_40828`
